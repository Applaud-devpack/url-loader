...
To begin, you'll need to install `@applaud/url-loader`:

```console
$ npm install @applaud/url-loader --save-dev
```

`@applaud/url-loader` works like
...
The fallback loader will receive the same configuration options as @applaud/url-loader.
